...
const EditPost = ({ postId }) => {
  ...
  // Initial mock data for the post (replace this with an API fetch)
  const mockPostData = {
    postType: "sell", // "For Sell" or "For Rent"
    document: "ExampleDocument.pdf",
    houseName: "Luxury Villa",
    streetAddress: "123 Palm Beach Road",
    city: "Miami",
    district: "FL",
    price: "12500",
    type: "Villa",
  ...
  // Populate form with data (simulate fetching post data)
  useEffect(() => {
    // Simulating an API call to get the post details using postId
    // Replace `mockPostData` with your API call to fetch post data
    setForm(mockPostData);
  }, [postId]);
  ...
  return (
    <div className="container mx-auto  my-12">
      {/* Header */}
      <h1 className="text-center text-3xl font-bold text-green-600 mb-8">Edit Post</h1>

      {/* Form */}
      <div className="max-w-4xl mx-auto bg-white p-8 border rounded-lg shadow-lg">
        {/* Post Type */}
        <div className="mb-6">
          <p className="text-gray-700 font-semibold">Edit Post Type:</p>
          <Radio.Group
